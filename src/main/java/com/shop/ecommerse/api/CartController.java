...
import com.shop.ecommerse.domain.request.cart.*;
import com.shop.ecommerse.domain.response.cart.CartResponse;
import com.shop.ecommerse.service.CartService;
...
public class CartController extends ApiController{
    ...
    public ResponseEntity<CartResponse> removeFromCart(@RequestBody @Valid RemoveItemFromCartRequest removeFromCartRequest) {
